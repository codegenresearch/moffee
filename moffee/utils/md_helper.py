...
def is_divider(line: str, type=None) -> bool:
    """\n    Determines if a given line is a Markdown divider (horizontal rule).\n    Markdown dividers are defined as:\n    - Horizontal: '<->' repeated three or more times.\n    - Vertical: '===' repeated three or more times.\n\n    :param line: The line to check\n    :param type: Which type to match, str. e.g. "<" to match "<->" only. Defaults to None, match any of "<" and "=".\n    :return: True if the line is a divider, False otherwise\n    """
    ...
    if type == "<":
        ...
        raise ValueError("type must be either '<' or '='")
